...
import com.xiaoheizi.client.view.components.panels.MessagesJPanel;
import com.xiaoheizi.client.view.exceptions.InvalidMessageException;
...
//        moreOptions1.addActionListener(e -> clearMessages());
    ...
    private void initOptionsButton() {
        String imagePath = HC ? "hamburgerHC.png" : "hamburger.png";
        try (InputStream inputStream = IKunnect.class.getClassLoader().getResourceAsStream(imagePath)) {
            if (inputStream != null) {
                Image image = ImageIO.read(inputStream);
                Image scaledImage = image.getScaledInstance(50, 50, Image.SCALE_SMOOTH);
                options = new JButton(new ImageIcon(scaledImage));
            } else {
                System.err.println("Could not find file: " + imagePath);
            }
