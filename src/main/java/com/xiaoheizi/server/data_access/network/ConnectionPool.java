...
class ConnectionPool {
    ...
    private void handleConnections() {
        for (int i = 0; !serverSocket.isClosed(); i++) {
            try {
                ...
                networkManager.addMessageToTerminal("Some com.ikun.client connected");
    ...
    /**
     * Closes the resources associated with the com.ikun.server.
     * <p>
     * This method is used to close the com.ikun.server's resources, including the com.ikun.server socket
     ...
     * each com.ikun.client's send queue. Additionally, it logs the action in the network manager's
     * terminal output.
     *
