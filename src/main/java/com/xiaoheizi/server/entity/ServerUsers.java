...
/**
 * The ServerUsers class represents a collection of users on the com.ikun.server.
...
public class ServerUsers implements IFile<ServerUsers> {
    ...
    /**
     * The list of users registered on the com.ikun.server.
     */
    @Expose
    ...
    /**
     * Adds a new user to the com.ikun.server with the specified username and password.
     *
    ...
    /**
     * Retrieves a com.ikun.server user based on the provided username.
     *
     * @param username The username of the user to retrieve.
     * @return The com.ikun.server user with the specified username, or null if not found.
     */
    ...
    /**
     * Retrieves a com.ikun.server user based on the provided user ID.
     *
     * @param userId The user ID of the user to retrieve.
     * @return The com.ikun.server user with the specified user ID.
     */
    ...
    public class User implements ServerUser {
        ...
        /**
         * The User class represents a com.ikun.server user with associated details.
         */
